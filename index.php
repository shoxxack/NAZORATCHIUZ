...
<?php
ob_start();
define('API_KEY', '1282704672:AAGno9NM3zU8qfsqR3y12uoxiQHm96fu3ZE');
//tokenni yozing
$admin = "1171894731"; 
...
if($text1 == "/start" or $text1 == "/start@Qitmirhonbot"){
  ...
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'Buyruqlar', 'callback_data' => "stat"],['text'=>'Statistika', 'callback_data' => "stat1"]],
          [['text'=>'Guruhga Qo‘shish','url'=>'telegram.me/Qitmirxon_0_bot?startgroup=new']]
]   
]),
]);
}
...
['inline_keyboard' => [
  ...
  [['text'=>'Guruhga Qo‘shish','url'=>'telegram.me/Qitmixon0_bot?startgroup=new']]
]
]),
]);
}
...
- Bot guruh yangi a‘zolari bilan salomlashadi.Guruh a‘zosi guruhga reklama <b>ssilkalarini</b> tashlasa yoki <b>haqoratli</b> so‘z yozsa,bot xabarni o‘chirib foydalanuvchiga cheklov beradi.\n\n<b>Yaratuvchi🛠:</b>  <a href='tg://user?id=1171894731'>Shox_Xacker</a>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['url' => 'https://telegram.me/Qitmirxon0_bot?startgroup=new', 'text' => "Guruhga Qo‘shish"],],
]
]),
]);
}

if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@Qitmirxon0_bot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['url' => 'https://telegram.me/Qitmirhonbot?startgroup=new', 'text' => "Guruhga Qo‘shish"],],
]
]),
]);
}
...
if((stripos($mtext,"Qashqadaryo")!==false)){
$input = array("Wow,men ham Qashqadaryo lik man","Hamshahar  ekanmiz☺","Men ham Qashqadaryo likman😊","Qayeridan?","Bitta joydan ekanmiz");
  $rand=rand(0,4);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
...
$input = array("Ha","Ha shunaqa","Hm shunday","Haye.","Ha rost");
 ...
 if($fadmin==$admin){
    bot('sendmessage',[
      'chat_id'=>$chat_id,
      'text'=>"Vay mana meni yaratgan inson keldilar 😘 @Shox_Xacker cham😉.",
      ]);
  }else{
  $name = $message->from->first_name;
